...
##            call(command)
        ...
        if effect == 'None':
            ...
            clr = gs.getPixel(10,10)
            dist = gs.colorDistance(scv.Color.GREEN)#No idea why, but it worked
            GBs = dist.findBlobs()
            matte = GBs[-1].image.binarize()
            background = scv.Image("/home/pi/git/TouchSelfie/Photos/GS_Backdrops/WWIncr1.png")
